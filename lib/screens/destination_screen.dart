import 'package:bots360_app/models/activity_model.dart';
import 'package:flutter/material.dart';
import 'package:bots360_app/models/destination_model.dart';
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                ...
                return Stack(
                  children: <Widget>[
                    Container(margin: const EdgeInsets.fromLTRB(40.0, 5.0, 20.0, 5.0),
                    height: 170.0,
                ...
                borderRadius: BorderRadius.circular(20.0)
                      ...
                      child: Column(
                        ...
                        Row(
                          ...
                          Column(
                            children: <Widget> [
                          Text('P${activity.price}', style: const TextStyle
                            (fontSize: 22.0,
                              fontWeight: FontWeight.w600,
                          )
                          ),
